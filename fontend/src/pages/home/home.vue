...
<template>
    <div class="home-wrapper">
        <div class="home">
            <a href="https://github.com/xiaoxcx/vue_project" class="github-corner" target="_blank" aria-label="Follow me on GitHub">
        ...
        <div class="dynamic">
            <div class="github-time-line" v-loading='githubLoading'>
                ...
                <div class="github-time-line-item" v-for='(item, index) in githubCommitStatus' :key='index'>
...
export default {
  ...
  methods: {
    ...
    getGithubCommitStatus() {
      this.$axios
        ...
        // 'https://api.github.com/repos/xiaoxcx/duck_prophet/commits'
        )
        .then(res => {
          console.log(res)
  ...
  filters: {
    ...
    // 把接口传出的时间"2019-11-18T14:26:29Z"转成毫秒数
      val = new Date(val).getTime();
    //   console.log("val:"+val)
    //   得到的毫秒数进行一个新的时间整合并返回一个新的格式
